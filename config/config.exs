...
config :game_together_online, GameTogetherOnlineWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: GameTogetherOnlineWeb.ErrorHTML, json: GameTogetherOnlineWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: GameTogetherOnline.PubSub,
  live_view: [signing_salt: "YlhaATU3"]
...
config :game_together_online, GameTogetherOnline.Mailer, adapter: Swoosh.Adapters.Local
